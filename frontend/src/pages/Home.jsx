      ...
      <div style={{ marginBottom: 24 }}>
        {!showForm ? (
          <button onClick={() => setShowForm(true)} style={{
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.background = 'rgba(200,132,61,0.06)'; }}
...
function StatCard({ icon, value, label }) {
  return (
    <div style={{
      ...
      <div style={{ display: 'inline-flex', padding: 8, background: 'rgba(200,132,61,0.10)', borderRadius: 10, marginBottom: 8, color: 'var(--gold)' }}>
        {icon}
      </div>
...
function BookCard({ book, index, onOpen, onArchive, onDelete }) {
  ...
  return (
    <div
      ...
      onClick={() => onOpen(book)}
      onMouseEnter={e => {
        e.currentTarget.style.borderColor = 'rgba(200,132,61,0.35)';
        e.currentTarget.style.boxShadow = 'var(--shadow-lg), 0 0 0 1px rgba(200,132,61,0.10)';
